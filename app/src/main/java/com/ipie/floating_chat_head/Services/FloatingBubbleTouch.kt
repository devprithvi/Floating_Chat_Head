...
import com.ipie.floating_chat_head.Services.FloatingBubbleAnimator

/**
 * Touch event for the Floating Bubble Service
 * Created by bijoysingh on 2/19/17.
 */
class FloatingBubbleTouch private constructor(builder: Builder) : OnTouchListener {
    ...
    class Builder {
        ...
        fun OnClicklistener(`val`: View.OnClickListener?): Builder {
            onClickListener = `val`
            return this
        }
